...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('bbcDraK5B3', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ECbeiWzdH0', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('krT6SLTDNw', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('B9ByworO7R', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rI4Z+e9rF2', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SJsqr+VgMp', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mUa8bRaNDN', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder8dc8c = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer07ee3 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesbe3c9 = [
        
    ];

    public function getConnection()
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'getConnection', array(), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'getMetadataFactory', array(), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'getExpressionBuilder', array(), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'beginTransaction', array(), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'getCache', array(), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->getCache();
    }

    public function transactional($func)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'transactional', array('func' => $func), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'wrapInTransaction', array('func' => $func), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'commit', array(), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->commit();
    }

    public function rollback()
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'rollback', array(), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'getClassMetadata', array('className' => $className), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'createQuery', array('dql' => $dql), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'createNamedQuery', array('name' => $name), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'createQueryBuilder', array(), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'flush', array('entity' => $entity), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'clear', array('entityName' => $entityName), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->clear($entityName);
    }

    public function close()
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'close', array(), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->close();
    }

    public function persist($entity)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'persist', array('entity' => $entity), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'remove', array('entity' => $entity), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'refresh', array('entity' => $entity), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'detach', array('entity' => $entity), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'merge', array('entity' => $entity), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'getRepository', array('entityName' => $entityName), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'contains', array('entity' => $entity), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'getEventManager', array(), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'getConfiguration', array(), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'isOpen', array(), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'getUnitOfWork', array(), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'getProxyFactory', array(), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'initializeObject', array('obj' => $obj), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'getFilters', array(), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'isFiltersStateClean', array(), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'hasFilters', array(), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return $this->valueHolder8dc8c->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer07ee3 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder8dc8c) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder8dc8c = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder8dc8c->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, '__get', ['name' => $name], $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        if (isset(self::$publicPropertiesbe3c9[$name])) {
            return $this->valueHolder8dc8c->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder8dc8c;
    ...
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;
    ...
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, '__isset', array('name' => $name), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;
    ...
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, '__unset', array('name' => $name), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;
    ...
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, '__clone', array(), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        $this->valueHolder8dc8c = clone $this->valueHolder8dc8c;
    }

    public function __sleep()
    {
        $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, '__sleep', array(), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;

        return array('valueHolder8dc8c');
    }
    ...
    {
        $this->initializer07ee3 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer07ee3;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer07ee3 && ($this->initializer07ee3->__invoke($valueHolder8dc8c, $this, 'initializeProxy', array(), $this->initializer07ee3) || 1) && $this->valueHolder8dc8c = $valueHolder8dc8c;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder8dc8c;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder8dc8c;
    }
